...
const Popup = ({setOpenPopup, setUpdateTable}: PropsType) => {
    ...
    const handleSubmit = (e: FormEvent) => {
        ...
        axios.put(`/api/edit_folder/${productData._id}`, inputData).then((res) => {
    ...
    <div className='fixed top-0 left-0 w-full h-screen bg-[#00000070] grid place-items-center'>
        ...
        <Image 
            ...
            src={inputData.imgSrc ? inputData.imgSrc : "/placeholder.jpg"}
            width={800}
            height={500}
            alt="product_image"
            />
            ...
            onClientUploadComplete={(res) => {
                console.log(res);
                setInputData({ ...inputData, imgSrc: res[0]?.url });
            }}
