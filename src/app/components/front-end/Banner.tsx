        ...
        <div className="container mt-32">
            <div className="grid lg:grid-cols-[66%,34%] gap-4 pr-[15px]">
                <div className="h-[200px] md:h-[260px] bg-[url(/product-banner-1.jpg)] bg-cover bg-center rounded-xl p-8 md:p-16">
                    ...
                    <a className="text-white inline-block mt-6 hover:text-accent text-topHeadingSecondary font-medium"
                    href="#"
                    >
                      Shop Now
                    </a>
                </div>
                <div className="h-[260px] bg-cover bg-center rounded-xl hidden lg:block" style={{ backgroundImage: "url('/product-banner-2.jpg')" }}></div>
            </div>
        </div>
    );
};
